...
class DogCardAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DogCardViewHolder {
        ...
        val layoutToUse: View = when (layout) {
        ...
        //  the inflated layout.
        return DogCardViewHolder(layoutToUse)
    }
    ...
    override fun onBindViewHolder(holder: DogCardViewHolder, position: Int) {
        ...
        holder.ageText.text = resources?.getString(R.string.dog_age, data.age)
        holder.hobbiesTextView.text=resources?.getString(R.string.dog_hobbies,data.hobbies)
